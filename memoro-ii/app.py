...
def generate_response(query):
    ...
    response = openai.chat.completions.create(
            model='gpt-4o-mini',
            messages=[
                {"role": "system", "content": "Your name is AIDA and you are a memory assistant \
                 listening to my conversations. You are capable of listening to my conversations and \
                 responding to details of historical conversations. Your response should be in the same \
